...
using Helper.Validations.Dependency;
...
builder.Services.ConfigureValidationsDependency();
...
app.UseMiddleware<ExceptionHandlingMiddleware>(builder.Services.BuildServiceProvider());
